...
Then you can do it in your shell:
...
```
[Service]
Environment="SENDGRID_API-KEY=xxx"
```

### Provide the API key when calling `sendgrid:send-mail`

`api-key` is one of the parameters of `sendgrid:send-mail`.

By default, we read it from the environment variables.
...
* How to send emails with cl-smtp: https://dev.to/vindarel/send-emails-with-common-lisp-smtp-gmail-sendgrid-mailgun-4aac
